...
Actions.prototype.init = function()
{
	...
	////////////////!!!!!!!!!!!!!!!!!!!! THESE ARE THE ACTIONS TO ADD PROCESS ,INPUT, OUTPUT, JUCTION !!!!!!!!!!!!!!!////////////////////////
	
	//////Process///////////
	this.addAction('process', function()
	{
		...
		try
			{   graph.getModel().beginUpdate();
				var v1 = graph.insertVertex(parent, null, 'Process',
							20, 20, 160, 60, 'rounded=1;');
	...
	///////////////Junction//////////
	this.addAction('junction', function()
	{
		var parent = graph.getDefaultParent();
		...
		try
			...
			var v2 = graph.insertVertex(parent, null, 'Junction',20, 20, 50, 50, 
		...
		this.addAction('input', function()
	{
		...
		try
			...
			var v3 = graph.insertVertex(parent, null, 'Input',20, 20, 120, 80, 
	...
	//////////////////////output/////////////////////////
		...
		this.addAction('output', function()
	{
		var parent = graph.getDefaultParent();
		...
		try
			...
			var v3 = graph.insertVertex(parent, null, 'Output',20, 20, 120, 80, 
