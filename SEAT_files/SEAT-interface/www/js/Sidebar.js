...
/**
 * Adds  palettes to the sidebar.
 */
Sidebar.prototype.init = function()
{
	var dir = STENCIL_PATH;
	
    this.ProcessPalette(true); 
	this.JunctionPalette(true);
...
//////my function////
Sidebar.prototype.ProcessPalette = function(expand)
{
    ...
    this.addPaletteFunctions('AddProcess', 'Process', (expand != null) ? expand : true, fns);
};

Sidebar.prototype.JunctionPalette = function(expand)
{
    var lineTags = 'line lines connector connectors connection connections arrow arrows ';

    var fns = [
        
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', 'Junction', null, null, 'Junction'),
    ...
    this.addPaletteFunctions('Junction', 'Junction', (expand != null) ? expand : true, fns);
};
